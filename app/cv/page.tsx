  ...
  return (
    <CVWrapper>
      <div className="relative w-[61rem] rounded-md bg-[#1e2738] px-10 py-5">
        ...
        <div className="mb-8 flex justify-center gap-10 border-y border-white/20 py-4 text-sm">
        ...
        <div className="grid flex-1 grid-cols-[2fr_1.1fr] leading-relaxed tracking-wider">
          <div className="col-start-1 col-end-2 row-start-1 row-end-2 mr-4 flex flex-col border-b border-white/20 pb-6">
            ...
            <p>
              ...
              HTML, CSS, JavaScript/TypeScript, and tools like Tailwind CSS.
              I&apos;m passionate about writing clean, scalable code and
              delivering polished UI experiences.
            </p>
          </div>
